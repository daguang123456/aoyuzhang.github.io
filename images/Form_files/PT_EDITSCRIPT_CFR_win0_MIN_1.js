...
{
msg = PSmessageSubst_win0(msg, PSwarning_win0.arguments, 1);if (isFModeLayout()) 
 psConfirmFluid("Avert.", msg, "", "", "", "");else
 psAlert(msg, "Avert.");}
...
msg = PSmessageSubst_win0(msg, PSerror_win0.arguments, 2);if (isFModeLayout()) 
 psConfirmFluid("Erreur", msg, "", "", "", "");else
 psAlert(msg, "Erreur");oErr_win0=obj;}
...
{
var s = prompt("Entrez cha\u00eene de recherche :","");if (s == null || s == "")
...
var deleteAction = 'oParentWin.aAction_win0(oParentWin.document.win0' + ',"' + name + '")';if (typeof CKEDITOR != 'undefined') UpdateEditorLinkedField();psConfirm2("Confirmation suppression", "Supprimer les enregistrements courants/s\u00e9lectionn\u00e9s? La suppression aura lieu \u00e0 la sauvegarde.", "OKCancel", " ", deleteAction);}

function DeleteCheck2_win0(name)
{
gFocusObj = document.getElementById(name);if (arguments.length == 0) 
 return confirm("Supprimer les enregistrements courants/s\u00e9lectionn\u00e9s? La suppression aura lieu \u00e0 la sauvegarde.");else if(arguments.length ==1 && (typeof event != 'undefined') && event.altKey && bAccessibility_win0 && !isFModeLayout())
 return confirm("Supprimer les enregistrements courants/s\u00e9lectionn\u00e9s? La suppression aura lieu \u00e0 la sauvegarde.");else 
 {
 if (bAccessibility_win0 && !PT_isModalDialogPresent()) 
 var deleteAction = 'submitAction_win0(document.win0' + ',"' + arguments[0] + '")'; else 
 var deleteAction = 'oParentWin.aAction_win0(oParentWin.document.win0' + ',"' + arguments[0] + '")';     if (isFModeLayout())
 psConfirmFluid("Confirmation suppression", "Supprimer les enregistrements courants/s\u00e9lectionn\u00e9s de cette page?", "OKCancel", " ", deleteAction, "La suppression sera effectu\u00e9e au moment de l\'enregistrement de la transaction."); else 
 {
 if (typeof CKEDITOR != 'undefined') UpdateEditorLinkedField(); psConfirm2("Confirmation suppression", "Supprimer les enregistrements courants/s\u00e9lectionn\u00e9s? La suppression aura lieu \u00e0 la sauvegarde.", "OKCancel", " ", deleteAction); }
 }
}

function AddMultiple_win0(obj)
{
var msg = "Nombre d\'enregistrements \u00e0 ajouter:";var defreply = "1";while(true)
{
 ...
 msg = "Valeur non valide. Entrez un nombre compris entre 1 et 100." 
 + "\n" + "Nombre d\'enregistrements \u00e0 ajouter:"; defreply = RegExp.$1;}
}
...
{
if (obj == null) return;if (isFModeLayout() && oChange_win0 != obj && (obj.type == "checkbox" || obj.type == "radio")) 
{
 var sScript = obj.getAttribute('onclick'); if (sScript && sScript.indexOf("submitAction_") != -1) {
 oChange_win0 = null; return; }
}


if (typeof gridRowSelRgbColor_win0 != "undefined") {
...
if (typeof dateBoxOpen != "undefined" && dateBoxOpen)
 closeCal2(obj);var nRCFLastKey = getLastKey_win0();if(!bTabonly || nRCFLastKey == "\t".charCodeAt(0))
{
 if(oChange_win0!=null && oChange_win0!=obj)
 {
 if (oChange_win0.form){
 oChange_win0.form.ICFocus.value=obj.id; oChange_win0.form.ICFocus.nRCFLastKey = nRCFLastKey; submitAction_win0(oChange_win0.form,oChange_win0.id); }
 else{
 if (document.getElementById(oChange_win0.id) && document.getElementById(oChange_win0.id).form ){
 document.getElementById(oChange_win0.id).form.ICFocus.value = obj.id; document.getElementById(oChange_win0.id).form.ICFocus.nRCFLastKey = nRCFLastKey; submitAction_win0(document.getElementById(oChange_win0.id).form,oChange_win0.id); }
 }
...
if (typeof dateBoxOpen != "undefined" && dateBoxOpen)
 closeCal2();document.win0.ICFocus.value = obj.id;if(oDefErr_win0!=null && oDefErr_win0!=obj)
 ...
 val = obj.value;if (val.search(/^ *$/) == 0 || (bnumeric && val.search(/^[ 0]*$/) == 0))
{
 ...
 PSdeferError(obj, "Ce champ est obligatoire."); }
}

function addchg_win0(obj,id) {

if (typeof obj == "undefined" && typeof id == "undefined") return;if (obj) id = obj.id; else obj = document.getElementById(id);if (!obj || id.length == 0) return;if (isLoaderInProcess() && obj.type == "button") {
 return;}
if (isFModeLayout() && obj.type == "select-one")
 setDropDown(id);if (typeof bCleanHtml == "undefined" || !bCleanHtml) return;try {
 if (typeof document.chgFldArr_win0 != "undefined" && document.chgFldArr_win0 != "undefined")
 {
...
{
 submitAction_win0(obj.form,obj.id); return true;}
...
if (obj.type == "checkbox")
 ...
 {
 var arr = obj.form[obj.id]; for (var i = 0; i < arr.length; ++i)
...
{
if (!isChanged(obj))
 return false;PSdeferError_win0(obj, "Les enregistrements courants ou historiques ne peuvent \u00eatre modifi\u00e9s qu\'en mode Corriger.");bReset_win0 = true;return true;}

function subscrollUpdated_win0(obj)
{
if (!isChanged(obj))
 return false;PSdeferError_win0(obj, "Champ cl\u00e9 avec donn\u00e9es subordonn\u00e9es avec date d\'effet modifiable en mode Corriger seulement.");bReset_win0 = true;return true;}
...
if(obj.type == "select-one") obj = obj.options[obj.selectedIndex];var dateval = new Date(obj.value);var now = new Date();var diff = new Date(Math.abs(now.getTime() - dateval.getTime()));if (diff.getMonth > 0)
 ...
 PSdeferWarning_win0("Avertissement -- date non valide.");return false;}
 ...
 val = obj.value;if (val != 'Y' && val != 'N')
{
 ...
 PSdeferError_win0(obj, "Valeur accept\u00e9e : O pour oui ou N pour non."); return true;}
return false;}
...
var val = obj.value;if (val == '') return false;if (val.search(/^ *\d* *$/) != 0)
{
 ...
 PSdeferError_win0(obj, "Ce format est erron\u00e9 pour un champ num\u00e9rique. Corrigez-le."); return true;}
return false;}
...
var val = obj.value;if (val == '') return false;if (val.search(re) != 0)
{
 ...
 PSdeferError_win0(obj, "Erreur de format de champ num\u00e9rique. Ce champ accepte les valeurs num\u00e9riques %1. %2", fmt); return true;}
return false;}
...
var val = obj.value;if (val == '') return false;if (!checkTime(val,fmt))
{
 ...
 PSdeferError_win0(obj, "Format d\'heure erron\u00e9. Utilisez le format standard."); return true;}
return false;}
...
var val = obj.value;if (val == '') return false;var newval = checkDateTime(val,fmt);if (newval == "")
{
 ...
 PSdeferError_win0(obj, "Format date/heure erron\u00e9. Utilisez le format standard."); return true;}
...
var dmy = fmt.substring(0, 3);var sep = fmt.substring(3, 4);if(sep === '\\'){
 sep += '\\';}

var sepchars = "-/.";var sepstr = "\\-\/\\.";if (sepchars.indexOf(sep)==-1)
...
var todaystr = "auj.".toUpperCase();if (val.length > 0 && todaystr.indexOf(val.toUpperCase()) == 0) 
...
var bIE = (navigator.userAgent.toLowerCase().indexOf('msie') || navigator.userAgent.toLowerCase().indexOf('trident'));if (typeof selectElemOptions_win0 != "undefined")
 ...
 continue;   var invalidValueText = "(Valeur non valide)"; for (var l = curLen - 1; l >= 0; l--) 
 {
